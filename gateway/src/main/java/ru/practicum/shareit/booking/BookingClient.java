...
public class BookingClient extends BaseClient {
    ...
    public List<BookingDtoResponse> getAllByBooker(long userId, State state, Long from, Integer size) {
    ...
    public List<BookingDtoResponse> getAllByOwner(long userId, State state, Long from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "state", state.name(),
                "from", from,
                "size", size
    ...
    public BookingDtoResponse add(long userId, BookingDtoRequest bookingDto) {
        return post("", userId, bookingDto, BookingDtoResponse.class);
    }
    ...
    public BookingDtoResponse approve(long userId, Long bookingId, Boolean approved) {
        return patch("/" + bookingId + "?approved=" + approved, userId, BookingDtoResponse.class);
    }
}
