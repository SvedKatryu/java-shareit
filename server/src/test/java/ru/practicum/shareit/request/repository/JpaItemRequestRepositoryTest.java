...
class JpaItemRequestRepositoryTest {
    ...
    public void setUp() {
        ...
        savedRequest1 = itemRequestRepository.save(itemRequest1);
    ...
    public void findItemRequestsFromUser_ReturnRequestsWithoutItemsFromRequester() {
        List<ItemRequest> requests = itemRequestRepository.findRequestsFromUser(savedUser2.getId());
    ...
    public void findItemRequestsFromUser_ReturnRequestsWithItemsFromRequester() {
        List<ItemRequest> requests = itemRequestRepository.findRequestsFromUser(savedUser1.getId());
    ...
    public void findAllByOrderByCreatedDesc_From0Size1_ShouldReturnListOfItemRequest() {
        ...
        Page<ItemRequest> requests = itemRequestRepository.findAvailableRequests(savedUser1.getId(),
                pageRequest);
