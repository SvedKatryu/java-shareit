...
class CommentRepositoryTest {
    ...
    void findAllByItemId_ShouldReturnAllCommentsOnItem2() {
        List<Comment> comments = commentRepository.findAllByItemId(savedItem2.getId());
    ...
    void findAllByItemId_WhenItemWithoutComments_ShouldReturnEmptyList() {
        List<Comment> comments = commentRepository.findAllByItemId(savedItem3.getId());
    ...
    void findAllByItemIdIn_ShouldReturnAllCommentsFromItem1AndItem2() {
        List<Comment> comments = commentRepository.findAllByItemIdIn(List.of(savedItem1.getId(), savedItem2.getId()));
    ...
    void findAllByItemIdIn_OnlyFromItem2_ShouldReturnAllCommentsFromItem2() {
        List<Comment> comments = commentRepository.findAllByItemIdIn(List.of(savedItem2.getId()));
    ...
    void findAllByItemIdIn_OnlyFromItem3_ShouldReturnEmptyList() {
        List<Comment> comments = commentRepository.findAllByItemIdIn(List.of(savedItem3.getId()));
